        ...
        <div className="flex items-center gap-2">
          ...
          {user ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-1.5 rounded-full text-sm bg-blue-600 text-white hover:bg-blue-700 transition-colors font-medium whitespace-nowrap"
            >
